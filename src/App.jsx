...
const CATS = [
  { id:"health",        label:"Health & Well-being",       emoji:"ðŸ’ª", color:"#0EA5E9",  quote:"Take care of your body. It's the only place you have to live.",                          author:"Jim Rohn",            instruction:"Reflect on and write down your health and well-being goals.",                              photoLabel:"Attach images that inspire a healthy lifestyle, vitality, and well-being" },
  { id:"spirituality",  label:"Spirituality & Mindfulness", emoji:"ðŸ™", color:"#8B5CF6",  quote:"Faith is taking the first step even when you don't see the whole staircase.",             author:"Martin Luther King Jr.", instruction:"Reflect on and write down your spiritual goals.",                                        photoLabel:"Attach photos that evoke spirituality, serenity, or connection with the divine" },
  { id:"career",        label:"Career & Business",          emoji:"ðŸš€", color:"#D4962A",  quote:"The best way to predict the future is to create it.",                                     author:"Peter Drucker",       instruction:"Reflect on and write down your career aspirations and business goals.",                  photoLabel:"Attach photos that represent your desired business achievements or career aspirations" },
  { id:"relationships", label:"Relationships & Connections", emoji:"â¤ï¸", color:"#EF4444",  quote:"The quality of your life is the quality of your relationships.",                          author:"Tony Robbins",        instruction:"Reflect on and write down your relationship goals and ways to nurture them.",            photoLabel:"Attach photos that represent love, friendship, and meaningful connections" },
  { id:"finances",      label:"Finances & Abundance",       emoji:"ðŸ’°", color:"#10B981",  quote:"Wealth is not about having a lot of money. It is about having a lot of options.",        author:"Chris Rock",          instruction:"Reflect on and write down your financial goals.",                                       photoLabel:"Attach photos that symbolize abundance, financial prosperity, or your desired lifestyle" },
  { id:"travel",        label:"Travel & Adventure",         emoji:"âœˆï¸", color:"#06B6D4",  quote:"The world is a book and those who do not travel read only one page.",                    author:"Saint Augustine",     instruction:"Reflect on and write down your travel and adventure goals.",                            photoLabel:"Attach photos of dream travel destinations and thrilling activities" },
  { id:"hobbies",       label:"Hobbies & Creativity",       emoji:"ðŸŽ¨", color:"#F59E0B",  quote:"Creativity is intelligence having fun.",                                                  author:"Albert Einstein",     instruction:"Reflect on and write down your hobbies and creative pursuits.",                          photoLabel:"Attach photos related to your favourite hobbies and creative inspirations" },
  { id:"home",          label:"Home & Environment",         emoji:"ðŸ¡", color:"#84CC16",  quote:"Home is not a place. It is a feeling.",                                                   author:"Cecelia Ahern",       instruction:"Reflect on and write down your vision for your ideal living space.",                    photoLabel:"Attach photos of beautiful homes, interior designs, or serene natural settings" },
  { id:"contribution",  label:"Contribution & Legacy",      emoji:"ðŸŒ", color:"#6366F1",  quote:"We make a living by what we get but we make a life by what we give.",                    author:"Winston Churchill",   instruction:"Reflect on and write down ways to give back and make a positive impact.",               photoLabel:"Attach photos that symbolize acts of kindness and philanthropy" },
];
...
const MS_EMOJIS = ["ðŸŒŸ","ðŸ†","ðŸŽ¯","ðŸš€","ðŸ’«","âœ…","ðŸ™","ðŸŽ‰","ðŸ’°","â¤ï¸","ðŸŒ","ðŸ”‘","ðŸ‘‘","ðŸ’Ž","ðŸŒˆ","â­","ðŸ¦‹","ðŸŒº","ðŸ”¥","ðŸ’ª"];
...
function TabBar({active,onNav}){
  const tabs=[["home","ðŸ ","Vision"],["milestones","ðŸŒŸ","Milestones"],["howto","ðŸ“–","How To"],["install","ðŸ“²","Install"]];
  return(
...
export default function App(){
  ...
  const [msEmoji,setMsEmoji]=useState("ðŸŒŸ");
      ...
      <div style={{maxWidth:420,width:"100%"}}>
        {oStep===0&&(
          <div className="fade" style={{textAlign:"center"}}>
            <div style={{fontSize:72,marginBottom:24,animation:"float 3s ease-in-out infinite"}}>âœ¨</div>
            ...
            <p style={{color:"rgba(255,255,255,.72)",fontSize:15,lineHeight:1.85,maxWidth:320,margin:"0 auto 36px"}}>A portable vision book for manifesting your dream life â€” always with you, everywhere you go.</p>
            <Btn onClick={()=>setOStep(1)} style={{background:WH,color:BDK,width:"100%",padding:16,fontSize:15,borderRadius:14}}>Begin My Journey â†’</Btn>
          </div>
        )}
        {oStep===1&&(
          <div className="fade" style={{background:WH,borderRadius:24,padding:32,textAlign:"center"}}>
            <div style={{fontSize:44,marginBottom:16}}>ðŸ‘‘</div>
            ...
            <Btn onClick={()=>setOStep(2)} disabled={!uName.trim()} style={{background:BDK,color:WH,width:"100%",padding:15,borderRadius:14}}>Continue â†’</Btn>
          </div>
        )}
        {oStep===2&&(
          <div className="fade" style={{background:WH,borderRadius:24,padding:32,textAlign:"center"}}>
            ...
            <div style={{display:"flex",gap:10}}>
              ...
              <Btn onClick={()=>setScreen("home")} style={{flex:2,background:BDK,color:WH,padding:15,borderRadius:14}}>Enter My Manifesto âœ¨</Btn>
            </div>
          </div>
        )}
      </div>
  ...
  // â”€â”€ CATEGORY EDITOR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      <div style={{minHeight:"100vh",background:BG,paddingBottom:40}}>
        <div className="page-wrap">
          ...
          <div style={{background:`linear-gradient(160deg,${cat.color}18,${cat.color}04)`,borderBottom:`2px solid ${cat.color}18`,padding:"28px 20px 22px"}}>
            <button onClick={()=>{setScreen("home");setShowKit(false);}} style={{background:"transparent",border:"none",color:MT,cursor:"pointer",fontSize:14,fontWeight:500,marginBottom:18,display:"flex",alignItems:"center",gap:6}}>â† Back</button>
            <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:16}}>
              ...
              <div style={{flex:1}}>
                ...
                <p style={{fontSize:12,color:MT}}>{filled} of 5 written Â· {pct}% complete</p>
              </div>
            ...
            <div style={{borderLeft:`3px solid ${cat.color}`,paddingLeft:14}}>
              ...
              <p style={{fontSize:11,color:cat.color,fontWeight:700,marginTop:4}}>â€” {cat.author}</p>
            </div>
          </div>

          {/* â”€â”€ WRITING SECTION â”€â”€ */}
          <div style={{padding:"24px 20px 0"}}>
            ...
            <div style={{background:BLT,borderRadius:12,padding:"12px 14px",marginBottom:22,display:"flex",gap:10,alignItems:"flex-start"}}>
              ...
              <p style={{fontSize:12,color:BDK,lineHeight:1.65}}>Write in the <strong>present tense</strong> â€” as if it's already yours. Feel the emotion behind every word.</p>
            </div>

            {/* Guide line â€” OUTSIDE the box, stands alone above the numbered lines */}
            ...
            <div style={{display:"flex",gap:10,marginBottom:16}}>
              ...
              <Btn onClick={()=>photoRef.current.click()} style={{flex:1,background:BLT,color:BDK,fontSize:13,padding:"11px 12px"}}>ðŸ“· Camera Roll</Btn>
              <Btn onClick={()=>setShowKit(s=>!s)} style={{flex:1,background:showKit?BDK:BLT,color:showKit?WH:BDK,fontSize:13,padding:"11px 12px"}}>ðŸ” Search Photos</Btn>
            </div>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8}}>
                    {(INSPO[cat.id]||[]).map((url,i)=>(
                      <div key={i} onClick={()=>addFromKit(cat.id,url)} style={{aspectRatio:"1",borderRadius:10,overflow:"hidden",position:"relative",cursor:"pointer",border:`2px solid ${d.inspo.includes(url)?cat.color:"transparent"}`}}>
                        ...
                        {d.inspo.includes(url)&&<div style={{position:"absolute",top:5,right:5,background:cat.color,borderRadius:"50%",width:22,height:22,display:"flex",alignItems:"center",justifyContent:"center"}}><span style={{color:WH,fontSize:11,fontWeight:700}}>âœ“</span></div>}
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:10,marginBottom:20}}>
                {all.map((src,i)=>(
                  <div key={i} style={{aspectRatio:"1",borderRadius:12,overflow:"hidden",position:"relative"}}>
                    ...
                    <button onClick={()=>{if(i<d.photos.length)removePhoto(cat.id,i);else toggleInspo(cat.id,src);}} style={{position:"absolute",top:5,right:5,background:"rgba(0,0,0,.65)",border:"none",color:WH,borderRadius:"50%",width:24,height:24,cursor:"pointer",fontSize:12,display:"flex",alignItems:"center",justifyContent:"center"}}>âœ•</button>
                  </div>
                ))}
              </div>
            )}
  ...
  // â”€â”€ DAILY REVIEW â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if(screen==="review"){
      ...
      <div style={{position:"fixed",inset:0,zIndex:300,background:"#0C1A2E"}}>
        ...
        <div style={{position:"relative",zIndex:1,height:"100%",display:"flex",flexDirection:"column",justifyContent:"space-between",padding:"clamp(32px,6vw,56px) clamp(20px,5vw,40px)"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            ...
            <button onClick={()=>{setScreen("home");setRevIdx(0);}} style={{background:"rgba(255,255,255,.15)",border:"none",color:WH,borderRadius:"50%",width:38,height:38,cursor:"pointer",fontSize:18,display:"flex",alignItems:"center",justifyContent:"center"}}>âœ•</button>
          </div>
          <div className="rev">
            ...
            <p style={{fontFamily:"'Playfair Display',serif",fontStyle:"italic",fontSize:14,color:"rgba(255,255,255,.35)",lineHeight:1.7,marginTop:24}}>"{cat.quote}" â€” {cat.author}</p>
          </div>
          <div style={{display:"flex",gap:12}}>
            {revIdx>0&&<Btn onClick={()=>setRevIdx(i=>i-1)} style={{flex:1,background:"rgba(255,255,255,.1)",color:WH,border:"1px solid rgba(255,255,255,.2)"}}>â† Prev</Btn>}
            {revIdx<revCats.length-1
              ?<Btn onClick={()=>setRevIdx(i=>i+1)} style={{flex:2,background:cat.color,color:WH}}>Next â†’</Btn>
              :<Btn onClick={()=>{setScreen("home");setRevIdx(0);}} style={{flex:2,background:cat.color,color:WH}}>Complete âœ¨</Btn>}
          </div>
        </div>
      </div>
      </>
        ...
        <div style={{padding:"20px 20px 0"}}>
          ...
          {milestones.length===0
            ?<div style={{textAlign:"center",padding:"48px 20px",color:MT}}>
              <div style={{fontSize:52,marginBottom:16}}>ðŸŒŸ</div>
              ...
              {milestones.map((m,i)=>(
                <div key={m.id} className="fade" style={{background:WH,border:`1px solid ${BD}`,borderRadius:16,padding:18,boxShadow:"0 2px 8px rgba(0,0,0,.05)",animationDelay:`${i*.04}s`}}>
                  <div style={{display:"flex",gap:14,alignItems:"flex-start"}}>
                    ...
                    <button onClick={()=>setMilestones(ms=>ms.filter(x=>x.id!==m.id))} style={{background:"transparent",border:"none",color:MT,cursor:"pointer",fontSize:16,padding:4}}>âœ•</button>
                  </div>
                </div>
              ))}
            </div>}
  ...
  // â”€â”€ HOW TO â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if(screen==="howto") return(
    ...
    <div style={{minHeight:"100vh",background:BG,paddingBottom:90}}>
      <div className="page-wrap">
        ...
        <div style={{padding:"24px 20px 0"}}>
          {[
            {n:"1",title:"Set aside dedicated time",color:BDK,body:"Find a quiet and comfortable space where you can engage with the book without distractions. Set aside a specific time each day â€” morning works best."},
          ...
          <div style={{background:`linear-gradient(135deg,${BDK},${BL})`,borderRadius:20,padding:24,marginTop:8,marginBottom:24,textAlign:"center"}}>
            ...
            <p style={{color:"rgba(255,255,255,.55)",fontSize:13,fontWeight:600}}>â€” Dream Life Manifesto</p>
          </div>
        </div>
      </div>
      <TabBar active={screen} onNav={navTo}/>
    ...
    <div style={{minHeight:"100vh",background:BG,paddingBottom:90}}>
      <div className="page-wrap">
        ...
        <div style={{padding:"24px 20px"}}>
          {[
            {label:"ðŸŽ iPhone / iPad â€” Use Safari",color:BDK,steps:["Open this link in Safari (not Chrome)","Tap the Share icon at the bottom â€” box with arrow pointing up","Scroll down and tap Add to Home Screen","Tap Add in the top right corner","Dream Life Manifesto appears on your home screen"]},
            {label:"ðŸ¤– Android â€” Use Chrome",color:"#34A853",steps:["Open this link in Chrome","Tap the 3-dot menu at the top right","Tap Add to Home screen","Tap Add to confirm","Dream Life Manifesto appears on your home screen"]},
    ...
    <div style={{minHeight:"100vh",background:BG,paddingBottom:90}}>
      <div className="page-wrap">
        <div style={{background:`linear-gradient(135deg,${BDK},${BL})`,padding:"48px 20px 28px"}}>
          <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:18}}>
            {uPhoto
              ...
              :<div style={{width:56,height:56,borderRadius:"50%",background:"rgba(255,255,255,.2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:26}}>âœ¨</div>}
            <div>
          ...
          <div style={{background:"rgba(255,255,255,.13)",borderRadius:16,padding:"16px 18px",marginBottom:18,backdropFilter:"blur(6px)"}}>
            ...
            <p style={{fontSize:11,color:"rgba(255,255,255,.5)",fontWeight:700,letterSpacing:.5}}>â€” {dq.a}</p>
          </div>
        ...
        <div style={{padding:"18px 20px 0"}}>
          <Btn onClick={()=>{setRevIdx(0);setScreen("review");}} style={{width:"100%",padding:16,fontSize:15,background:GD,color:WH,borderRadius:14,marginBottom:6}}>â–¶ Start Daily Review</Btn>
          ...
          <div style={{textAlign:"center",padding:"36px 0 0"}}>
            ...
            <p style={{color:GD,fontSize:12,fontWeight:700,marginTop:10}}>â€” Andre Knight</p>
            <p style={{color:MT,fontSize:11,marginTop:18}}>Dream Life Manifesto Â· dreamlifemanifesto.com</p>
          </div>
        </div>
      </div>
      <TabBar active={screen} onNav={navTo}/>
